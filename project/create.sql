...
CREATE TABLE ObsWeather(
	...
	CONSTRAINT fk_station FOREIGN KEY(StationNum) references Station(StationID) on delete cascade on update cascade,
...
create table Note(
	...
	CONSTRAINT fk_station FOREIGN KEY(N_StationID) references Station(StationID) on delete cascade on update cascade,
...
create table Record(
	...
	CONSTRAINT fk_station FOREIGN KEY(R_StationID) references Station(StationID) on delete cascade on update cascade
);